...
public class Tutorial2Activity extends Activity implements CvCameraViewListener2 {
    ...
    private static final int       VIEW_MODE_MORPH2     = 22;
    ...
    private MenuItem               mItemViewMorph2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //m_baseApi.init("/mnt/sdcard/tesseract", "eng", "/mnt/sdcard/anpr");
        m_baseApi.init("/mnt/sdcard/tesseract", "eng");
        
        m_baseApi.setPageSegMode(TessBaseAPI.PageSegMode.PSM_SINGLE_LINE);
        m_baseApi.setVariable("tessedit_char_whitelist", "ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890");
        m_baseApi.setVariable("tessedit_unrej_any_wd", "0");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mItemViewMorph2 = menu.add("Morph2a");
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
       ...
       // Matrix mtx = new Matrix();
        ...
        if (mPlateOnly.width() > 0 && mPlateOnly.height() > 0) {
            ...
            //baseline[0] = 0;
            //Size textSize = Core.getTextSize(recognisedText, Core.FONT_HERSHEY_PLAIN, 3, 3, baseline);
            
            Core.putText(mRgba, recognisedText, new Point(10,100),  Core.FONT_HERSHEY_SIMPLEX, 2,  new Scalar(0,255,0,255), 3);
            //baseApi.end();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item == mItemViewMorph2) {
            mViewMode = VIEW_MODE_MORPH2;
